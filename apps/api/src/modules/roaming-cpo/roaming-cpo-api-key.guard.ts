...
export class RoamingCpoApiKeyGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    request.roamingCpoPartnerId = verified.partnerId;
    return true;
  }
}
