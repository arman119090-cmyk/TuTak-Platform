 ...
 * roaming-CPO-provider stations are excluded server-side (product decision,
 * 2026-08-26 — see `EvStationsService.listNearby`), so this screen never has
 * to special-case one: whatever `nearbyStations` returns always gets the ordinary
