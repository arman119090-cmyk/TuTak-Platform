...
export const BRANDS = [
  {
    ...
    isPremium: true,
    tagline: {
      hy: 'Երևանյան արհեստանոց՝ 2009 թվականից',
      ru: 'Ереванская мастерская с 2009 года',
      en: 'A Yerevan workshop since 2009',
    },
    description: {
      hy: 'Մեր արտադրամասը Երևանում պատրաստում է փափուկ կահույք՝ եվրոպական ֆուռնիտուրայով և տեղական փայտով։',
      ru: 'Собственный цех в Ереване: мягкая мебель на европейской фурнитуре и местном дереве.',
      en: 'An in-house Yerevan workshop: upholstery on European hardware and local timber.',
    },
  },
  {
    slug: 'sevan-home',
    ...
    isPremium: false,
    tagline: {
      hy: 'Պարզ կահույք ամենօրյա կյանքի համար',
      ru: 'Простая мебель для каждого дня',
      en: 'Simple furniture for every day',
    },
    description: {
      hy: 'Հասանելի գներ և պահեստում առկա մոդելներ՝ առանց երկար սպասելու։',
      ru: 'Доступные цены и модели со склада — без долгого ожидания производства.',
      en: 'Accessible prices and stocked models — no long production wait.',
    },
  },
  {
    slug: 'ararat-craft',
    ...
    isPremium: true,
    tagline: {
      hy: 'Փայտի զանգված և ձեռքի աշխատանք',
      ru: 'Массив дерева и ручная работа',
      en: 'Solid wood and hand craft',
    },
    description: {
      hy: 'Կաղնու և հացենու զանգվածից կահույք՝ ձեռքով հղկված և յուղով մշակված։',
      ru: 'Мебель из массива дуба и ясеня: ручная шлифовка, масляное покрытие.',
      en: 'Solid oak and ash furniture, hand-sanded and oil finished.',
    },
  },
  {
    slug: 'amberd',
    name: 'Amberd Furniture',
    country: 'AM',
    foundedYear: 2016,
    isPremium: false,
    tagline: {
      hy: 'Պահեստավորում փոքր բնակարանների համար',
      ru: 'Хранение для небольших квартир',
      en: 'Storage for small apartments',
    },
    description: {
      hy: 'Կոմպակտ պահարաններ և համակարգեր՝ մինչև 60 սմ խորությամբ։',
      ru: 'Компактные шкафы и системы хранения глубиной до 60 см.',
      en: 'Compact wardrobes and storage systems up to 60 cm deep.',
    },
  },
  {
    slug: 'vayk-studio',
    ...
    isPremium: false,
    tagline: {
      hy: 'Ժամանակակից ձևեր, մատչելի գին',
      ru: 'Современные формы по доступной цене',
      en: 'Modern shapes at a fair price',
    },
    description: {
      hy: 'Երիտասարդ ստուդիա, որը նախագծում է կահույք փոքր բնակարանների համար։',
      ru: 'Молодая студия, проектирующая мебель под малогабаритные квартиры.',
      en: 'A young studio designing furniture for compact flats.',
    },
  },
  {
    slug: 'orbeli-design',
    ...
    isPremium: true,
    tagline: {
      hy: 'Ավտորական դիզայն ինտերիերի համար',
      ru: 'Авторский дизайн для интерьера',
      en: 'Signature design pieces',
    },
    description: {
      hy: 'Սահմանափակ շարքեր՝ դիզայներների հետ համատեղ մշակված։',
      ru: 'Ограниченные серии, разработанные вместе с дизайнерами интерьера.',
      en: 'Limited runs developed together with interior designers.',
    },
  },
  {
    slug: 'tavush-oak',
    ...
    isPremium: false,
    tagline: {
      hy: 'Տավուշյան կաղնի՝ սեղանների համար',
      ru: 'Тавушский дуб для столов и стульев',
      en: 'Tavush oak for tables and chairs',
    },
    description: {
      hy: 'Ճաշի խմբեր տեղական կաղնուց՝ ամուր և պարզ։',
      ru: 'Обеденные группы из местного дуба: прочно и без лишнего декора.',
      en: 'Dining sets in local oak: sturdy, without extra decoration.',
    },
  },
  {
    slug: 'lorra-milano',
    ...
    isPremium: true,
    tagline: {
      hy: 'Իտալական ֆասադներ և կաշի',
      ru: 'Итальянские фасады и кожа',
      en: 'Italian facades and leather',
    },
    description: {
      hy: 'Ներմուծվող հավաքածուներ՝ լաքապատ ֆասադներով և բնական կաշվով։',
      ru: 'Импортные коллекции с лакированными фасадами и натуральной кожей.',
      en: 'Imported collections with lacquered facades and full-grain leather.',
    },
  },
  {
    slug: 'nordvik',
    ...
    isPremium: false,
    tagline: {
      hy: 'Սկանդինավյան պարզություն',
      ru: 'Скандинавская простота',
      en: 'Scandinavian plainness',
    },
    description: {
      hy: 'Բաց փայտ, լակոնիկ ձևեր և ազնիվ նյութեր։',
      ru: 'Светлое дерево, лаконичные формы и честные материалы.',
      en: 'Pale wood, quiet shapes and honest materials.',
    },
  },
  {
    slug: 'kastel-co',
    ...
    description: {
      hy: 'Գործարանային արտադրություն՝ կայուն որակով և կարճ ժամկետներով։',
      ru: 'Фабричное производство со стабильным качеством и короткими сроками.',
      en: 'Factory production with stable quality and short lead times.',
    },
  },
  {
    slug: 'zangi-wood',
    ...
    isPremium: false,
    tagline: {
      hy: 'Մանկական և պատանեկան կահույք',
      ru: 'Детская и подростковая мебель',
      en: 'Kids and teen furniture',
    },
    description: {
      hy: 'Անվտանգ ծածկույթներ, կլորացված անկյուններ, աճող մոդելներ։',
      ru: 'Безопасные покрытия, скруглённые углы, мебель «на вырост».',
      en: 'Safe finishes, rounded corners and furniture that grows.',
    },
  },
  {
    slug: 'arpa-home',
    ...
    description: {
      hy: 'Աշխատատեղեր և պահեստավորում՝ 2–50 հոգանոց թիմերի համար։',
      ru: 'Рабочие места и хранение для команд от 2 до 50 человек.',
      en: 'Workstations and storage for teams of 2 to 50.',
    },
  },
] as const;
...
export const LEAF_CONFIG: Record<string, LeafConfig> = {
  ...
  'two-seat-sofas': {
    ...
    room: 'living',
    skuPrefix: 'SF-TWO',
    smallSpaceMaxWidth: 1750,
  },
  'three-seat-sofas': {
    kind: 'sofa',
    price: [210_000, 620_000],
    dims: [
      [1950, 2350],
      [880, 1000],
      [780, 920],
  ...
  'classic-armchairs': {
    ...
    room: 'living',
    skuPrefix: 'AC-CLS',
    smallSpaceMaxWidth: 950,
  },
  'lounge-armchairs': {
    kind: 'armchair',
    price: [120_000, 430_000],
    dims: [
      [750, 1000],
      [800, 1000],
      [700, 900],
    ...
    room: 'living',
    skuPrefix: 'AC-LNG',
    smallSpaceMaxWidth: 1000,
  },
  recliners: {
    kind: 'armchair',
    price: [250_000, 680_000],
    dims: [
      [850, 1000],
      [950, 1150],
      [1000, 1100],
    ...
    colors: SOFT_COLORS,
    materials: ['ecoLeather', 'genuineLeather', 'velour', 'microfiber'],
    styles: MODERN_STYLES,
    room: 'living',
    skuPrefix: 'AC-REC',
  },
  'office-armchairs': {
    kind: 'armchair',
    price: [92_000, 290_000],
    dims: [
      [620, 720],
      [650, 780],
      [1050, 1300],
    ],
    colors: ['black', 'anthracite', 'graphite', 'grey', 'navy'],
    materials: ['ecoLeather', 'microfiber', 'genuineLeather'],
    styles: ['modern', 'hitech', 'minimal'],
    room: 'office',
    purpose: 'office',
    skuPrefix: 'AC-OFF',
  },
  ...
  'single-beds': {
    ...
    colors: CASE_COLORS,
    materials: [...WOOD_BOARD, 'chenille', 'velour'],
    styles: ALL_STYLES,
    room: 'bedroom',
    skuPrefix: 'BD-SGL',
    smallSpaceMaxWidth: 1200,
  },
  'double-beds': {
    kind: 'bed',
    price: [198_000, 580_000],
    dims: [
      [1600, 1900],
      [2050, 2200],
      [900, 1250],
    ...
    colors: CASE_COLORS,
    materials: [...WOOD_BOARD, 'boucle', 'velour', 'ecoLeather'],
    styles: ALL_STYLES,
    room: 'bedroom',
    skuPrefix: 'BD-DBL',
  },
  'king-size-beds': {
    ...
    colors: CASE_COLORS,
    materials: ['velour', 'boucle', 'genuineLeather', 'oakSolid', 'veneer'],
    styles: ALL_STYLES,
    room: 'bedroom',
    skuPrefix: 'BD-KNG',
  },
  ...
  'kids-beds': {
    kind: 'kids',
    price: [110_000, 275_000],
    dims: [
      [900, 1100],
      [1700, 2050],
      [700, 1400],
    ],
    colors: ['white', 'ivory', 'oak', 'ashWood', 'powder', 'blue', 'olive'],
    materials: ['mdfPainted', 'chipboard', 'pineSolid', 'plywood'],
    styles: ['scandi', 'modern', 'minimal'],
    room: 'kids',
    purpose: 'kids',
    skuPrefix: 'BD-KID',
    smallSpaceMaxWidth: 1100,
  },
  'pocket-spring-mattresses': {
    kind: 'mattress',
    price: [98_000, 430_000],
    dims: [
      [800, 2000],
      [1900, 2100],
      [190, 320],
    ...
    colors: ['white', 'ivory'],
    materials: ['microfiber', 'linenFabric'],
    styles: ['modern'],
    room: 'bedroom',
    warranty: 60,
    skuPrefix: 'MT-PKT',
  ...
  'walk-in-wardrobes': {
    ...
    colors: CASE_COLORS,
    materials: [...WOOD_BOARD, 'metal'],
    styles: ['modern', 'minimal', 'loft'],
    room: 'bedroom',
    skuPrefix: 'WR-WLK',
  },
  dressers: {
  ...
  nightstands: {
    ...
    room: 'bedroom',
    skuPrefix: 'NS-TMB',
    smallSpaceMaxWidth: 600,
  },
  shelving: {
    kind: 'shelving',
    price: [58_000, 268_000],
    dims: [
      [600, 1800],
      [300, 420],
      [1500, 2200],
    ],
    colors: [...CASE_COLORS, 'black'],
    materials: [...WOOD_BOARD, 'metal', 'plywood'],
    styles: ['loft', 'modern', 'minimal', 'scandi'],
    room: 'living',
    skuPrefix: 'SH-STL',
    smallSpaceMaxWidth: 900,
  },
  'dining-tables': {
    kind: 'table',
    price: [128_000, 495_000],
    dims: [
      [1200, 2200],
      [800, 1100],
      [740, 790],
    ],
    colors: ['oak', 'ashWood', 'walnut', 'white', 'black', 'graphite', 'wenge'],
    materials: ['oakSolid', 'ashSolid', 'veneer', 'ceramic', 'quartz', 'mdfPainted', 'glass'],
    styles: ALL_STYLES,
    room: 'dining',
    skuPrefix: 'TB-DIN',
  },
  'coffee-tables': {
    kind: 'table',
    price: [58_000, 235_000],
    dims: [
      [700, 1300],
      [500, 800],
      [380, 480],
    ],
    colors: ['oak', 'walnut', 'black', 'white', 'marble' in COLORS ? 'white' : 'white', 'graphite'],
    materials: ['oakSolid', 'veneer', 'marble', 'glass', 'metal', 'mdfPainted'],
    styles: ALL_STYLES,
    room: 'living',
    skuPrefix: 'TB-CFF',
    smallSpaceMaxWidth: 900,
  ...
  'computer-desks': {
    kind: 'desk',
    price: [68_000, 228_000],
    dims: [
      [1100, 1600],
      [600, 800],
      [740, 1200],
    ],
    colors: ['white', 'black', 'graphite', 'oak', 'anthracite'],
    materials: [...WOOD_BOARD, 'metal', 'hpl'],
    styles: ['modern', 'hitech', 'minimal', 'loft'],
    room: 'office',
    skuPrefix: 'TB-CMP',
  },
  'folding-tables': {
    kind: 'table',
    price: [62_000, 189_000],
    dims: [
      [900, 1400],
      [600, 850],
      [740, 780],
  ...
  'office-tables': {
    kind: 'desk',
    price: [94_000, 310_000],
    dims: [
      [1200, 2400],
      [700, 900],
      [740, 760],
    ],
    colors: ['white', 'graphite', 'oak', 'anthracite', 'black'],
    materials: [...WOOD_BOARD, 'metal', 'hpl'],
    styles: ['modern', 'minimal', 'hitech'],
    room: 'office',
    purpose: 'office',
    skuPrefix: 'TB-OFF',
  },
  'kitchen-chairs': {
    ...
    colors: [...CASE_COLORS, 'emerald', 'navy', 'terracotta'],
    materials: ['beechSolid', 'metal', 'plastic', 'plywood', 'chenille'],
    styles: ALL_STYLES,
    room: 'kitchen',
    skuPrefix: 'CH-KIT',
  },
  'dining-chairs': {
    ...
    colors: SOFT_COLORS,
    materials: ['oakSolid', 'beechSolid', 'velour', 'boucle', 'ecoLeather', 'metal'],
    styles: ALL_STYLES,
    room: 'dining',
    skuPrefix: 'CH-DIN',
  },
  'bar-stools': {
    ...
    colors: SOFT_COLORS,
    materials: ['metal', 'ecoLeather', 'velour', 'plywood', 'plastic'],
    styles: ['loft', 'modern', 'hitech', 'minimal'],
    room: 'kitchen',
    skuPrefix: 'CH-BAR',
  },
  'office-chairs': {
    kind: 'chair',
    price: [46_000, 168_000],
    dims: [
      [550, 680],
      [560, 700],
      [900, 1250],
    ],
    colors: ['black', 'grey', 'anthracite', 'navy', 'graphite'],
    materials: ['microfiber', 'ecoLeather', 'metal', 'plastic'],
    styles: ['modern', 'hitech'],
    room: 'office',
    purpose: 'office',
    skuPrefix: 'CH-OFF',
  },
  'designer-chairs': {
    ...
    colors: SOFT_COLORS,
    materials: ['plywood', 'plastic', 'boucle', 'genuineLeather', 'rattan', 'metal'],
    styles: ['artdeco', 'japandi', 'scandi', 'modern'],
    room: 'dining',
    skuPrefix: 'CH-DSG',
  },
  'ready-kitchens': {
    kind: 'kitchen',
    price: [860_000, 3_200_000],
    dims: [
      [2400, 4200],
      [600, 640],
      [2150, 2400],
    ...
    colors: CASE_COLORS,
    materials: ['mdfPainted', 'chipboard', 'veneer', 'hpl'],
    styles: ALL_STYLES,
    room: 'kitchen',
    skuPrefix: 'KT-RDY',
  },
  'modular-kitchens': {
    ...
    colors: CASE_COLORS,
    materials: ['mdfPainted', 'chipboard', 'hpl'],
    styles: MODERN_STYLES,
    room: 'kitchen',
    skuPrefix: 'KT-MOD',
  },
  'upper-cabinets': {
    ...
    colors: CASE_COLORS,
    materials: ['mdfPainted', 'chipboard'],
    styles: MODERN_STYLES,
    room: 'kitchen',
    skuPrefix: 'KT-UPR',
  },
  ...
  'kitchen-islands': {
    ...
    colors: CASE_COLORS,
    materials: ['mdfPainted', 'quartz', 'oakSolid', 'hpl'],
    styles: MODERN_STYLES,
    room: 'kitchen',
    skuPrefix: 'KT-ISL',
  },
  countertops: {
    kind: 'countertop',
    price: [62_000, 268_000],
    dims: [
      [1800, 4000],
      [600, 900],
      [20, 60],
    ],
    colors: ['white', 'black', 'graphite', 'oak', 'beige', 'anthracite'],
    materials: ['quartz', 'ceramic', 'marble', 'hpl', 'oakSolid'],
    styles: MODERN_STYLES,
    room: 'kitchen',
    skuPrefix: 'KT-CTP',
  },
  ...
  'coat-racks': {
    ...
    colors: [...CASE_COLORS, 'black'],
    materials: ['metal', 'oakSolid', 'beechSolid', 'mdfPainted'],
    styles: MODERN_STYLES,
    room: 'hallway',
    skuPrefix: 'HL-CTR',
    smallSpaceMaxWidth: 900,
  ...
  'mirror-sets': {
    ...
    colors: CASE_COLORS,
    materials: ['glass', 'mdfPainted', 'oakSolid', 'metal'],
    styles: ALL_STYLES,
    room: 'hallway',
    skuPrefix: 'HL-MIR',
    smallSpaceMaxWidth: 900,
  ...
  kids: {
    kind: 'kids',
    price: [82_000, 330_000],
    dims: [
      [600, 1600],
      [400, 600],
      [800, 2000],
    ],
    colors: ['white', 'ivory', 'oak', 'powder', 'blue', 'olive', 'mustard'],
    materials: ['mdfPainted', 'chipboard', 'pineSolid', 'plywood'],
    styles: ['scandi', 'modern', 'minimal', 'provence'],
    room: 'kids',
    purpose: 'kids',
    skuPrefix: 'KD-GEN',
  },
  office: {
    kind: 'office',
    price: [94_000, 430_000],
    dims: [
      [800, 2000],
      [400, 800],
      [700, 2000],
    ],
    colors: ['white', 'graphite', 'oak', 'anthracite', 'black', 'ashWood'],
    materials: [...WOOD_BOARD, 'metal', 'hpl'],
    styles: ['modern', 'minimal', 'hitech', 'loft'],
    room: 'office',
    purpose: 'office',
    skuPrefix: 'OF-GEN',
  },
  'tv-stands': {
    ...
    colors: CASE_COLORS,
    materials: [...WOOD_BOARD, 'glass', 'metal'],
    styles: MODERN_STYLES,
    room: 'living',
    skuPrefix: 'LV-TVS',
  },
  ...
  'interior-doors': {
    kind: 'door',
    price: [56_000, 225_000],
    dims: [
      [600, 900],
      [36, 45],
      [2000, 2100],
    ],
    colors: ['white', 'ivory', 'oak', 'ashWood', 'walnut', 'wenge', 'graphite', 'anthracite'],
    materials: ['mdf', 'veneer', 'mdfPainted', 'hpl'],
    styles: ALL_STYLES,
    room: 'living',
    warranty: 36,
    skuPrefix: 'DR-INT',
  ...
  'entrance-doors': {
    kind: 'door',
    price: [186_000, 680_000],
    dims: [
      [860, 1000],
      [70, 110],
      [2050, 2150],
    ],
    colors: ['anthracite', 'graphite', 'walnut', 'wenge', 'black', 'brown'],
    materials: ['steel', 'mdf', 'veneer'],
    styles: ['modern', 'classic', 'hitech'],
    room: 'hallway',
    warranty: 60,
    skuPrefix: 'DR-ENT',
  },
  'sliding-doors': {
    kind: 'door',
    price: [92_000, 285_000],
    dims: [
      [700, 1000],
      [36, 40],
      [2000, 2400],
    ],
    colors: ['white', 'oak', 'ashWood', 'graphite', 'black'],
    materials: ['mdf', 'veneer', 'glass', 'metal'],
    styles: MODERN_STYLES,
    room: 'living',
    warranty: 36,
    skuPrefix: 'DR-SLD',
  ...
  'hidden-doors': {
    kind: 'door',
    price: [142_000, 365_000],
    dims: [
      [700, 900],
      [40, 48],
      [2000, 2400],
    ],
    colors: ['white', 'ivory', 'graphite', 'black'],
    materials: ['mdf', 'mdfPainted', 'metal'],
  ...
  'glass-doors': {
    kind: 'door',
    price: [124_000, 325_000],
    dims: [
      [700, 900],
      [8, 12],
      [2000, 2100],
    ],
    colors: ['white', 'graphite', 'black', 'grey'],
    materials: ['glass', 'metal'],
    styles: ['modern', 'loft', 'hitech'],
    room: 'living',
    warranty: 36,
    skuPrefix: 'DR-GLS',
  },
  'classic-doors': {
    kind: 'door',
    price: [92_000, 268_000],
    dims: [
      [600, 900],
      [38, 45],
      [2000, 2100],
    ],
    colors: ['ivory', 'walnut', 'wenge', 'oak', 'white'],
    materials: ['mdf', 'veneer', 'oakSolid'],
    styles: ['classic', 'neoclassic', 'provence'],
    room: 'living',
    warranty: 36,
    skuPrefix: 'DR-CLS',
  },
...
const buildSpecs = (
  ...
  switch (config.kind) {
    case 'sofa': {
      specs.mechanism =
        leafSlug === 'modular-sofas'
          ? 'none'
          : pick(rng, ['eurobook', 'dolphin', 'accordion', 'clickclack', 'rollout']);
      ...
      specs.seats =
        leafSlug === 'two-seat-sofas'
          ? 2
          : leafSlug === 'three-seat-sofas'
            ? 3
            : between(rng, 2, 5);
    ...
    case 'mattress': {
      specs.springType =
        leafSlug === 'springless-mattresses'
          ? 'springless'
          : pick(rng, ['pocket', 'pocket', 'bonnell']);
  ...
  for (const { node, rootSlug } of productLeaves()) {
    ...
    for (let i = 0; i < count; i += 1) {
      ...
      const brandCollections = COLLECTIONS.filter(
        (collection) => collection.brandSlug === brand.slug,
      );
      ...
      const oldPriceMinor = hasDiscount
        ? retailPrice(Math.round(basePrice / (1 - discountPct / 100)))
        : null;

      const stockRoll = rng();
      const stockStatus =
        stockRoll > 0.42 ? 'IN_STOCK' : stockRoll > 0.1 ? 'ON_ORDER' : 'OUT_OF_STOCK';
      ...
      const extraColors = [
        ...new Set([colorKey, ...Array.from({ length: 3 }, () => pick(rng, config.colors))]),
      ].slice(0, 4);
      const extraMaterials = [
        ...new Set([materialKey, ...Array.from({ length: 2 }, () => pick(rng, config.materials))]),
      ].slice(0, 3);
      ...
      extraColors.forEach((key, index) => {
        options.push({
          ...
          label: null,
          priceDeltaMinor:
            index === 0 ? 0 : retailPrice(Math.round(basePrice * (0.02 + rng() * 0.05))) - 900,
          isDefault: index === 0,
          sort: index,
        });
      });
      if (config.kind !== 'mattress' && config.kind !== 'countertop') {
        extraMaterials.forEach((key, index) => {
          options.push({
            ...
            label: null,
            priceDeltaMinor:
              index === 0 ? 0 : retailPrice(Math.round(basePrice * (0.04 + rng() * 0.08))) - 900,
            isDefault: index === 0,
            sort: index,
          });
        });
      ...
      sizeValues.forEach((value, index) => {
        options.push({
          ...
          label: `${value} мм`,
          priceDeltaMinor:
            index === 0 ? 0 : retailPrice(Math.round(basePrice * 0.06 * index)) - 900,
          isDefault: index === 0,
          sort: index,
        });
      });
      ...
      const translations = (['hy', 'ru', 'en'] as const).map((locale) => {
        ...
        const body = fillTemplate(
          BODY_TEMPLATES[(globalIndex + i) % BODY_TEMPLATES.length]![locale],
          values,
        );
        const closing = KIND_CLOSING[config.kind][locale];
        const short = fillTemplate(
          SHORT_TEMPLATES[globalIndex % SHORT_TEMPLATES.length]![locale],
          values,
        );
        return {
          locale,
      ...
      const searchText = [
        ...
        ...[colorKey, ...extraColors].map((key) =>
          Object.values(COLORS[key]?.label ?? {}).join(' '),
        ),
        ...[materialKey, ...extraMaterials].map((key) =>
          Object.values(MATERIALS[key]?.label ?? {}).join(' '),
        ),
        styleKey,
        node.slug,
        rootSlug,
