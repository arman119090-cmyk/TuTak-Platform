 ...
 * `apps/api` cannot: its `tsconfig.build.json` sets `rootDir` to
 * `apps/api/src` (the same constraint documented in
 ...
 * It keeps its own copy at
 * `apps/api/src/common/observability/sentry-sanitize.ts`;
