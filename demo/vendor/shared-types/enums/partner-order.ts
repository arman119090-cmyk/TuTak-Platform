...
export enum PartnerOrderOperationalStatus {
  ...
  /** Handed to the partner's courier — no customer timer. */
  OUT_FOR_DELIVERY = 'OUT_FOR_DELIVERY',
  /** Waiting at the branch for self-pickup — no customer timer. */
  READY_FOR_PICKUP = 'READY_FOR_PICKUP',
  /** The partner marked it delivered / handed to the customer — the 24h/48h clock starts. */
  DELIVERED = 'DELIVERED',
  RECEIVED = 'RECEIVED',
  COMPLETED = 'COMPLETED',
...
/** Item 8: a customer cancellation that may carry a partner cost claim. */
export enum PartnerOrderCancellationStatus {
  NONE = 'NONE',
  REQUESTED = 'REQUESTED',
  COST_REVIEW = 'COST_REVIEW',
}

export enum PartnerOrderCancellationRequestStatus {
...
export enum CancellationCostDecision {
  NO_CLAIM = 'NO_CLAIM',
  NO_COST = 'NO_COST',
  APPROVED = 'APPROVED',
  REDUCED = 'REDUCED',
...
export enum FinancialPolicyVersion {
  LEGACY_V1 = 'LEGACY_V1',
  COMMERCE_V2 = 'COMMERCE_V2',
}
...
export enum OrderEscalationType {
  ...
  PAYMENT_ISSUE_24H = 'PAYMENT_ISSUE_24H',
  CANCELLATION_COST_REVIEW = 'CANCELLATION_COST_REVIEW',
  RETURN_SHORTFALL_REVIEW = 'RETURN_SHORTFALL_REVIEW',
}

export enum PartnerOrderReturnStatus {
  PENDING_EXTERNAL_REFUND = 'PENDING_EXTERNAL_REFUND',
  COMPLETED = 'COMPLETED',
  /** Q9: the customer's shortfall is settled at the partner's desk first — nothing moved yet. */
  AWAITING_SHORTFALL_SETTLEMENT = 'AWAITING_SHORTFALL_SETTLEMENT',
  /** Q9: the customer refused/disputed the shortfall — TuTak decides; nothing moved. */
