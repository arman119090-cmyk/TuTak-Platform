...
| D-6 | Мобильное приложение не содержит ссылки на политику конфиденциальности; `apps/api/public/legal/privacy.html` не раздаётся ни одним сервисом | средняя (магазины, юрист) | BLOCKED BY EXTERNAL PARTY (юрист) + Арман (где хостить) |
