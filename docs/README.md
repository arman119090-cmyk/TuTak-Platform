...
| [legal-2026-09-22/](legal-2026-09-22/00_START_HERE_RU.md) | **Правовой пакет 22.09.2026.** Пять документов (RU/HY) внедрены в код вместе с публикационным gate, который держит их закрытыми: 41 незаполненное поле, метка «Проект для согласования», редакция не утверждена — 143 блокера. Согласия при регистрации: две независимые обязательные галочки, OTP не уходит до выбора, доказательство пишется в одной транзакции с аккаунтом и ссылается на редакцию с SHA-256 текста. Внутри: отчёт, таблица «положение документа → реализация → проверка», список данных и решений владельца, вопросы юристу, исходный пакет |
