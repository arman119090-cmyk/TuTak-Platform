...
| [READINESS_CHECKLIST_2026-09-21_RU.md](READINESS_CHECKLIST_2026-09-21_RU.md) | Рабочий список из 39 пунктов до READY: READY-A (реальные пользователи, деньги не через TuTak) и READY-B (деньги через Idram/баланс/POS). По каждому пункту статус, кто закрывает и чем считается закрытым; минимальный путь по номерам |
