...
export enum BonusEntryType {
  ...
  /** The core-business spec's deferred/"black" pool share, granted once its lot unlocks. */
  ACCRUAL_DEFERRED = 'ACCRUAL_DEFERRED',
  REDEMPTION_QR_PAYMENT = 'REDEMPTION_QR_PAYMENT',
  REDEMPTION_EV_CHARGING = 'REDEMPTION_EV_CHARGING',
  /** Bonus spent against a PurchaseIntent at a partner. */
  REDEMPTION_PARTNER_PURCHASE = 'REDEMPTION_PARTNER_PURCHASE',
  EXPIRY = 'EXPIRY',
  REVERSAL = 'REVERSAL',
